      ...
      <div className="mt-20 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3 md:gap-6 p-2 md:p-6 mb-20">
        {posts.map((post) => (
          <Link key={post._id} href={`/post/${post.slug.current}`} >
            <div className="group border border-gray-900 rounded-lg cursor-pointer overflow-hidden hover:shadow-md transition-shadow duration-200 ease-in-out hover:shadow-gray-800">
              ...
              <div className="flex justify-between p-5 border-gray-700">
                <div>
